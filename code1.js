...
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(24879164);
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(24878012);
}
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(24893284);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("swipe"), gdjs.bin_95gameCode.GDswipeObjects2);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(24894740);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.bin_95gameCode.GDbottleObjects1 */
