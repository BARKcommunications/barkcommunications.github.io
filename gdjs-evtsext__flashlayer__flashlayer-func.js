...
gdjs.evtsExt__FlashLayer__FlashLayer.asyncCallback28033332 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.camera.hideLayer(runtimeScene, eventsFunctionContext.getArgument("Layer"));
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__FlashLayer__FlashLayer.idToCallbackMap.set(28033332, gdjs.evtsExt__FlashLayer__FlashLayer.asyncCallback28033332);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(eventsFunctionContext.getArgument("Duration")), (runtimeScene) => (gdjs.evtsExt__FlashLayer__FlashLayer.asyncCallback28033332(runtimeScene, eventsFunctionContext, asyncObjectsList)), 28033332, asyncObjectsList);
}
}
