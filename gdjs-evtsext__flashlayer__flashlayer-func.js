...
gdjs.evtsExt__FlashLayer__FlashLayer.asyncCallback27019972 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.camera.hideLayer(runtimeScene, eventsFunctionContext.getArgument("Layer"));
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__FlashLayer__FlashLayer.idToCallbackMap.set(27019972, gdjs.evtsExt__FlashLayer__FlashLayer.asyncCallback27019972);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(eventsFunctionContext.getArgument("Duration")), (runtimeScene) => (gdjs.evtsExt__FlashLayer__FlashLayer.asyncCallback27019972(runtimeScene, eventsFunctionContext, asyncObjectsList)), 27019972, asyncObjectsList);
}
}
