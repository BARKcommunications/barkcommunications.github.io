...
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(25175900);
}
...
gdjs.fishing_95gameCode.asyncCallback25178844 = function (runtimeScene, asyncObjectsList) {
...
gdjs.fishing_95gameCode.idToCallbackMap.set(25178844, gdjs.fishing_95gameCode.asyncCallback25178844);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.fishing_95gameCode.asyncCallback25178844(runtimeScene, asyncObjectsList)), 25178844, asyncObjectsList);
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(25180436);
}
if (isConditionTrue_0) {
/* Reuse gdjs.fishing_95gameCode.GDspearObjects1 */
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, gdjs.fishing_95gameCode.mapOfGDgdjs_9546fishing_959595gameCode_9546GDspearObjects1Objects, 30, 140, "");
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(25169276);
}
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(25171812);
}
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(25173828);
}
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(25176636);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.fishing_95gameCode.GDfishObjects1 */
